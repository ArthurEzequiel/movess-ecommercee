(function ($) {
  ...
  function makeTimer() {
    ...
    var endTime = new Date("31 Dec 2023 12:56:00 GMT+01:00");
    ...
    $("#days").html("<span>Dias</span>" + days);
    $("#hours").html("<span>Horas</span>" + hours);
    $("#minutes").html("<span>Minutos</span>" + minutes);
    $("#seconds").html("<span>Segundos</span>" + seconds);
